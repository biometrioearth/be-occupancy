library(spOccupancy)
##occupancy for video data on a monthly level

# Load data
y <- readRDS("data_video_monthly.RDS") # [50species, 37sampling points (devices), 6 months]
sampling_sites <- vect("sampling_points.shp")
occ.cov <- sampling_sites[, c("ccibiomass","_firms", "aspect", "bare_spars", 
